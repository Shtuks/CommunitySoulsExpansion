...
public class MutantSpearDash : MutantSpearAttack
{
	...
	public override void AI()
	{
		...
		if (mutant.active && mutant.type == ModContent.NPCType<RealMutantEX>() && (mutant.ai[0] == 6f || mutant.ai[0] == 15f || mutant.ai[0] == 23f))
		{
	...
	{
		Texture2D glow = ModContent.Request<Texture2D>("ssm/Assets/ExtraTextures/RealMutantEX/MutantEye_Glow", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
