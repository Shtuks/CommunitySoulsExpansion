...
public class MutantBoss : ModProjectile
{
    ...
    public int npcType => ModContent.NPCType<RealMutantEX>();
	...
	public override bool PreDraw(ref Color lightColor)
	{
		...
		Texture2D texture2D14 = ModContent.Request<Texture2D>("ssm/Assets/ExtraTextures/RealMutantEX/MutantSoul", AssetRequestMode.ImmediateLoad).Value;
		...
		Texture2D aura = ModContent.Request<Texture2D>("ssm/Assets/ExtraTextures/RealMutantEX/MutantAura", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
		...
		if (this.sansEye)
		{
			...
			Texture2D star = ModContent.Request<Texture2D>("ssm/Assets/ExtraTextures/RealMutantEX/LifeStar", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
