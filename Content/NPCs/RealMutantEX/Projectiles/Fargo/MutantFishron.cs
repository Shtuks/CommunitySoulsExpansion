...
public class MutantFishron : ModProjectile
{
	...
	public override bool PreAI()
	{
		if (base.Projectile.localAI[0] > 85f)
		{
			...
			for (int index1 = 0; index1 < num22; index1++)
			{
				...
				int index2 = Dust.NewDust(vector + vector2_3, 0, 0, 161, vector2_2.X * 2f, vector2_2.Y * 2f, 100, default(Color), 1.4f);
	...
	public override void AI()
	{
		if (base.Projectile.localAI[1] == 0f)
		{
			...
			this.p = (CSEUtils.AnyBossAlive() ? Main.npc[FargoSoulsGlobalNPC.boss].target : Player.FindClosest(base.Projectile.Center, 0, 0));
