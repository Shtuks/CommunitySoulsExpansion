...
{
    public class RealMutantEXSky : CustomSky
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (FargoSoulsUtil.BossIsAlive(ref CSENpcs.RealMutantEX, ModContent.NPCType<RealMutantEX>())
                && (Main.npc[CSENpcs.RealMutantEX].ai[0] < 0 || Main.npc[CSENpcs.RealMutantEX].ai[0] >= 10))
            {
                intensity += increment;
                lifeIntensity = Main.npc[CSENpcs.RealMutantEX].ai[0] < 0 ? 1f : 1f - (float)Main.npc[CSENpcs.RealMutantEX].life / Main.npc[CSENpcs.RealMutantEX].lifeMax;
                ...
                switch ((int)Main.npc[CSENpcs.RealMutantEX].ai[0])
                {
                    case -5:
                        if (Main.npc[CSENpcs.RealMutantEX].ai[2] >= 420)
                    ...
                    case 36:
                        if (WorldSavingSystem.MasochistModeReal && Main.npc[CSENpcs.RealMutantEX].ai[2] > 180 * 3 - 60)
